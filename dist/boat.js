...
export function buildBoat(scene){
 ...
 const canvasMap=texture('canvas');canvasMap.repeat.set(3,5);const canvas=new T.MeshStandardMaterial({color:0xf3ead0,map:canvasMap,bumpMap:canvasMap,bumpScale:.027,roughness:.94,side:T.DoubleSide});
 ...
 // Two visible oars pivot at their rowlocks and dip into the water during each stroke.
